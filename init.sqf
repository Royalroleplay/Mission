...
ace_medical_enableunsconsiousnessai = 0; // AI Unconsciousness - Allow AI to go unconscious - Disabled = 0, Enabled = 1, 50/50 = 2
...
ace_medical_medicsetting_surgicalkit = 2; // Allow Surgical kit (Adv) - Who can use the surgical kit? - Anyone = 0, Medics only = 1, Doctors only (Adv) = 2
...
ace_medical_maxrevivetime = (60 * 15); // Max Revive time - Max amount of seconds a unit can spend in revive state
...
ace_medical_uselocation_surgicalkit = 2; // Locations Surgical kit (Adv) - Where can the Surgical kit be used? - Anywhere = 0, Medical Vehicles = 1, Medical facility = 2, Vehicles & facility = 3, Disabled = 4
...
ace_medical_uselocation_pak = 3; // Locations PAK (Adv) - Where can the personal aid kit be used? - Anywhere = 0, Medical Vehicles = 1, Medical facility = 2, Vehicles & facility = 3, Disabled = 4
ace_medical_littercleanupdelay = (60 * 5); // Life time of litter objects - How long should litter objects stay? In seconds. -1 is forever