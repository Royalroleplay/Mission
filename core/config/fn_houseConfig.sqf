...
switch (true) do {
	...
	case (_house in ["Land_HouseA","Land_HouseA1","Land_HouseB","Land_HouseB1","Land_HouseC_R","Land_HouseC1_L","Land_HouseA1_L","Land_HouseB1_L"]): {[10000000,0]};
	case (_house in ["Land_HouseDoubleAL2","Land_HouseDoubleAL"]): {[20000000,0]};
	default {[]};
};
