...
/* Log That Shit! */
[getPlayerUID player,life_cash,life_atmbank,(parseNumber(_val)),"Received Money",format["Recieved $%1 to %2",(parseNumber(_val)),(_from GVAR ["realname",name _from])]] remoteExec ["MBF_fnc_logTrans",hc_1];
